...
DEFS = -DVM_DEBUG -DVOMIT_FOREVER -DVM_NOPFQ #-DVOMIT_CORRECTNESS -DVOMIT_CURSES #-DVOMIT_BIG_ENDIAN
#DEFS = -DVM_DEBUG -DVOMIT_CORRECTNESS# -DVOMIT_CURSES #-DVOMIT_BIG_ENDIAN
#DEFS += -DVOMIT_SDL -DVOMIT_CURSES `sdl-config --cflags`
CFLAGS = -std=c99 -ggdb3 -pipe -O3 -W -Wall -pedantic -Wcast-qual -Wuninitialized -Wshadow -Wformat -Wimplicit -Wunused -Wundef -Wformat-security -Wpointer-arith -fPIC -Wwrite-strings

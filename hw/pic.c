...
static void pic_master_write( word, byte );
static byte pic_master_read( word );
static void pic_slave_write( word, byte );
static byte pic_slave_read( word );
...
void
pic_master_write( word port, byte data )
{
...
void
pic_slave_write( word port, byte data )
{
